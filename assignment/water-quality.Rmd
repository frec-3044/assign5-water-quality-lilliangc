...
**Answer 8: On most dates, the nitrate level does not exceed the set 10 mg/ml nitrate limit; however, there are some spikes in nitrate that do exceed the limit, especially in the years 2014-2018. **
...
ohio_sites <- as.double(df_site_list$site_id)


ohio_data <- map_dfr(ohio_sites, get_USGS_nitrate_data)
